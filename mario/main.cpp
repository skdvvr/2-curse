...
void CreateLevel(int lvl) {
    ...
    if (lvl == 2) {
        ...
        InitObject(GetNewMoving(), 15, 19, 2, 2, 'o');
        InitObject(GetNewMoving(), 35, 19, 2, 2, 'o');
        InitObject(GetNewMoving(), 55, 19, 2, 2, 'o');
        InitObject(GetNewMoving(), 75, 19, 2, 2, 'o');
    }
    ...
    if (lvl == 3) {
        ...
        InitObject(GetNewMoving(), 10, 19, 2, 2, 'o');
        InitObject(GetNewMoving(), 30, 14, 2, 2, 'o');
        InitObject(GetNewMoving(), 50, 19, 2, 2, 'o');
        InitObject(GetNewMoving(), 70, 14, 2, 2, 'o');
    }
